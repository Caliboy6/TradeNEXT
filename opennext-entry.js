import { initializePublic, initializePublicShell, reportWorkspaceFailure } from './opennext-public.js?v=opennext-20260912-5';
import './opennext-a11y.js?v=opennext-20260912-5';
...
try {
  await import('./phase1-entry-v2.js?v=opennext-20260912-5');
  const { procurementState } = await import('./procurement-data.js?v=opennext-20260912-5');
