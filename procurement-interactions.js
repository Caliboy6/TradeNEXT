import { state, providerDepth, escapeHtml } from "./demo-core.js?v=opennext-20260913-3";
import { rfqTypes, providerProfiles, provenanceCatalog, demandTape, quoteComparison, gpuSupplyListings, procurementState, ratingPolicy, completedTransactions, getSupplierReputation } from "./procurement-data.js?v=opennext-20260913-3";
