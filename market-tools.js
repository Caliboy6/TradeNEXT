import { modelMarkets, providerDepth, modelView, compactMoney, compactNumber, escapeHtml } from "./demo-core.js?v=opennext-20260913-4";
import { gpuSupplyListings, gpuDemandRatings, procurementState, getProvenance, getSupplierReputation } from "./procurement-data.js?v=opennext-20260913-4";
...
export function installMarketTools() {
  ...
  style.href = "./market-tools.css?v=opennext-20260913-4";
