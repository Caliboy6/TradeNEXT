...
export function renderLanding(locale = 'en') {
  ...
  return `<div class="public-page" lang="${locale}">
    ...
    <main>
      ...
      <section class="public-supplier-band" id="suppliers" aria-labelledby="public-supplier-title"><div class="public-container public-supplier-inner"><div class="public-supplier-heading"><p class="on-eyebrow">04 / A TWO-SIDED MARKET</p><h2 id="public-supplier-title">${c.band}</h2></div><div class="public-supplier-column"><p class="on-eyebrow">FOR BUYERS</p><p>${c.buyer}</p>${cta(c.buyerAction, 'rfq', 'text')}</div><div class="public-supplier-column"><p class="on-eyebrow">FOR SUPPLIERS</p><p>${c.supplier}</p>${cta(c.supplierAction, 'supply', 'text')}<small>${c.supplierNote}</small></div></div></section>
      <section class="public-closing public-container" aria-labelledby="public-closing-title"><div><p class="on-eyebrow">05 / GET STARTED</p><h2 id="public-closing-title">${c.closing}</h2><p>${c.closingDescription}</p></div>${cta(c.closingAction, 'rfq')}</section>
